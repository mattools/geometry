function tests = test_SimplePolygon2D(varargin)
%TEST_POLYGON2D  Test case for the file SimplePolygon2D
%
%   Test case for the file SimplePolygon2D

%   Example
%   test_SimplePolygon2D
%
%   See also
%
...
assertTrue(testCase, isa(poly2, 'SimplePolygon2D'));
